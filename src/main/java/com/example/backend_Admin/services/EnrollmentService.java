...
public class EnrollmentService {
    ...
    public boolean addEnrollment(EnrollmentDTO enrollmentDTO){
        ...
        String url = "http://localhost:9090/adminAPI/enrollments";
    ...
    public List<EnrollmentDTO> getAllEnrollmentsByRiderId(int id){
        RestTemplate restTemplate = new RestTemplate();
        String url = "http://localhost:9090/adminAPI/enrollments/user/"+ id;
    ...
    public String deleteEnrollmentById(int id){
        RestTemplate restTemplate = new RestTemplate();
        String url = "http://localhost:9090/adminAPI/enrollments/" + id;
